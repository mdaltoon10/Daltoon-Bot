...
- **پشتیبانی از چندین پنل** — همگام‌سازی و اتصال هوشمند به پنل‌های **Sanaei (3x-ui)**، **D-UI (نسخه ۱.۵.۸)**، **Reebeka** و **Pasarguard**.
...
ربات و داشبورد دالتون به طور کامل چندزبانه بوده و از زبان‌های مختلف پشتیبانی می‌کنند. در حال حاضر زبان‌های زیر به طور کامل پشتیبانی می‌شوند:

- 🇺🇸 **انگلیسی** (English - پیش‌فرض)
- 🇮🇷 **فارسی** (فارسی)
- 🇸🇦 **العربیه** (العربية)
- 🇷🇺 **روسی** (Русский)
- 🇹🇷 **ترکی** (Türkçe)
...
کاربران و مدیران می‌توانند به راحتی زبان مورد نظر خود را در تنظیمات برنامه تغییر دهند تا کل رابط کاربری، دکمه‌ها و پیام‌ها به صورت آنی هماهنگ و ترجمه شوند.

...
- **مینی‌اپ تلگرام (Mini App)** — امکان باز کردن وب‌اپلیکیشن اختصاصی داخل تلگرام جهت مشاهده سرویس‌ها، خرید آنی، شارژ کیف پول و بررسی حجم باقی‌مانده.
- **سیستم کیف پول** — کیف پول داخلی برای شارژ حساب و خرید آنی اشتراک توسط کاربران.
- **تنظیمات و نحوه تحویل اختصاصی به ازای هر سرور** — امکان تعیین درگاه‌های پرداخت مجاز هر سرور، شخصی‌سازی قالب ارسال لینک سابسکریپشن و اتصال مستقیم، متون سربرگ، پاورقی و جداکننده‌ها.
- **مدیریت پیشرفته اعلانات و پیام‌های ربات** — مدیریت ۲۴ نوع اعلان پیوی کاربر و ادمین شامل خرید موفق، تایید/رد فیش‌های واریزی، پاسخ تیکت‌ها، هشدارهای سرور و پشتیبان‌گیری.
- **مدیریت SSL و دامنه اختصاصی** — صدور خودکار و پیکربندی گواهی SSL (ZeroSSL / Certbot) و اتصال دامنه اختصاصی از طریق منوی مدیریت CLI [9] و پنل وب.
...
| **[9] SSL** | `🔒 SSL Certificate Setup` | پیکربندی و صدور گواهی SSL و تنظیم دامنه اختصاصی داشبورد. |
| **[10] Exit** | `🚪 Exit` | خروج از منوی مدیریت. |

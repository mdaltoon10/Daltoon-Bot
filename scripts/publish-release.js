...
- **🛡️ Anti-Bot & Human Verification Captcha Engine:**
  - Added Persian math and emoji challenges for new users and referral entries to completely eliminate fake spam bots.
- **⚙️ Bot Settings Captcha Toggle:**
  - Dedicated switch in panel settings to easily enable or disable captcha verification.
- **💰 Accurate Revenue Calculations:**
  - Filtered out internal wallet balance recharges and double-counting to present strictly genuine card-to-card and gateway earnings.
- **⚡ Preview & Startup Fixes:**
  - Cleaned service worker caches and fetch interception for instant loading on Chrome and mobile devices.
- **🔒 Security & Stability Improvements:**
  - Enhanced server middlewares and bot stability.`,
      draft: false,
      prerelease: false,
    };

...
- **Server Management & Custom Config Delivery UI**:
  - Restored v4.4.8 layout for Custom Config Delivery settings in the X-UI server management interface.
  - Added modern delivery format badges to the servers table.`,
      draft: false,
      prerelease: false,
    };

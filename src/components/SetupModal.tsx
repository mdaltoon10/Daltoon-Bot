...
export default function SetupModal({ lang, onComplete }: SetupModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-md z-[100] flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
      <div className="bg-[#0f172a] border border-[#1e293b] rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden my-auto max-h-[92vh] flex flex-col animate-fade-in animate-duration-300">
        <div className="bg-gradient-to-r from-indigo-500/10 to-transparent p-4 sm:p-6 border-b border-[#1e293b] shrink-0">
          <div className="flex items-center gap-3">
            <div className="bg-indigo-500/20 p-2.5 sm:p-3 rounded-xl border border-indigo-500/30 shrink-0">
              <UserCog className="w-5 h-5 sm:w-6 sm:h-6 text-indigo-400" />
            </div>
            <div>
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-5 overflow-y-auto flex-1 overscroll-contain">
          {error && (

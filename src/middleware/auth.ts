...
export function requireAdminAuth(req: Request, res: Response, next: NextFunction) {
  ...
  // Dev preview environment bypass (for Google AI Studio cloud developer preview containers)
  const isDevPreview =
    Boolean(process.env.APPLET_ID || process.env.K_SERVICE) ||
    Boolean(
      req.hostname && (
    ...
    Boolean(
      req.headers.host && (
        ...
        req.headers.host.includes("ais-dev") ||

export type ConfigDeliveryMode = "both" | "subscription_only" | "direct_only";
...
export interface ServerConfig {
  ...
  panelType?: "sanaei" | "rebecca" | "pasarguard" | "dui"; // Panel type (defaults to sanaei if undefined)
  deliveryMode?: ConfigDeliveryMode;
  deliverySeparator?: string;
...
export interface PanelSettings {
  ...
  btnTextAi?: string;
  hideBtnAi?: boolean;
  btnTextAddConfig?: string;
  hideBtnAddConfig?: boolean;
  btnTextConfigDetails?: string;
  ...
  configDeliverySeparator?: string;
  configDeliveryHeader?: string;
  configDeliverySubText?: string;
  configDeliveryDirectText?: string;
  configDeliveryFooter?: string;
  configDeliveryShowQr?: boolean;

  // Telegram Direct Notifications (پیوی ربات) Toggles
  notifyUserPurchase?: boolean;
  notifyUserReceiptApproved?: boolean;
  notifyUserReceiptRejected?: boolean;
  notifyUserFreeTest?: boolean;
  notifyUserTicketReply?: boolean;
  notifyUserWalletCharge?: boolean;
  notifyUserRenewSuccess?: boolean;
  notifyUserReferralReward?: boolean;
  notifyUserUsageWarning?: boolean;
  notifyUserFirstConnection?: boolean;
  notifyUserNoConnection?: boolean;
  notifyUserServiceToggle?: boolean;

  notifyAdminNewReceipt?: boolean;
  notifyAdminNewOrder?: boolean;
  notifyAdminNewTicket?: boolean;
  notifyAdminNewUser?: boolean;
  notifyAdminUserLeave?: boolean;
  notifyAdminUserUnblock?: boolean;
  notifyAdminChannelJoin?: boolean;
  notifyAdminInvite?: boolean;
  notifyAdminColleague?: boolean;
  notifyAdminFreeTest?: boolean;
  notifyAdminServerAlert?: boolean;
  notifyAdminBackup?: boolean;
  ...
  isCustomPricingActive?: boolean;

  // Time Zone & Calendar Settings
  timeZone?: string; // e.g. "Asia/Tehran", "UTC", "Europe/London", "America/New_York", etc.
  calendarType?: "jalali" | "gregorian"; // شمسی | میلادی
...
export interface Transaction {
  ...
  status: "pending" | "approved" | "rejected" | "refunded" | "failed" | string;
  date: string;
  description?: string;
  type?: string;

...
export const initialSettings: PanelSettings = {
  ...
  ownerId: 6536288293,
  isCustomPricingActive: true,
  configDeliveryMode: "both",
  configDeliverySeparator: "🔸━━━━━━━━━━━━━━━━━━🔸",
  configDeliveryHeader: "🎉 <b>خرید شما با موفقیت انجام شد!</b>",
  configDeliverySubText: "👇 <b>لطفاً از لینک سابسکریپشن اختصاصی خود استفاده کنید (جهت کپی لمس کنید):</b>",
  configDeliveryDirectText: "🚀 <b>لینک‌های اتصال مستقیم:</b>",
  configDeliveryFooter: "💡 لینک سابسکریپشن را کپی کرده و در برنامه v2rayNG یا V2box خود به عنوان Subscription وارد کرده و بروزرسانی نمایید.",
  configDeliveryShowQr: true,
  notifyUserPurchase: true,
  notifyUserReceiptApproved: true,
  notifyUserReceiptRejected: true,
  notifyUserFreeTest: true,
  notifyUserTicketReply: true,
  notifyUserWalletCharge: true,
  notifyUserRenewSuccess: true,
  notifyUserReferralReward: true,
  notifyUserUsageWarning: true,
  notifyUserFirstConnection: true,
  notifyUserNoConnection: true,
  notifyUserServiceToggle: true,
  notifyAdminNewReceipt: true,
  notifyAdminNewOrder: true,
  notifyAdminNewTicket: true,
  notifyAdminNewUser: true,
  notifyAdminFreeTest: true,
  notifyAdminServerAlert: true,
  notifyAdminBackup: true,
...
export const initialUsers: User[] = [
  { userId: 6536288293, username: "daltoon_admin", walletBalance: 250000, activePlansCount: 2, joinDate: "2026-05-12", status: "active", referralCount: 12, referralRewardTotal: 65000 },
  { userId: 512938474, username: "milad_kh", walletBalance: 120000, activePlansCount: 1, joinDate: "2026-05-15", status: "active", referralCount: 3, referralRewardTotal: 15000 },
